...
def basecfg(scenarioName, time, username, password, traceback):
    ...
    try:
        ...
        def createPacketHeader(
            trafficItemObj, packetHeaderToAdd=None, appendToStack=None
        ):
        ...
        ep1_eth1.Mac.Increment(
            start_value="00:11:01:00:00:01", step_value="00:00:00:00:00:01"
        )
        ...
        ep1_eth2.Mac.Increment(
            start_value="00:13:01:00:00:01", step_value="00:00:00:00:00:01"
        )
        ...
        # Note that there are are certain uses for some of the upper bits of MAC address.  Recommend always using 00 for the most significant 8 bits.
        ep3_eth1.Mac.Increment(
            start_value="00:12:01:00:00:01", step_value="00:00:00:00:00:01"
        )
        ...
        ep2_eth1.Mac.Increment(
            start_value="00:14:01:00:00:01", step_value="00:00:00:00:00:01"
        )
        ...
        ep2_eth2.Mac.Increment(
            start_value="00:15:01:00:00:01", step_value="00:00:00:00:00:01"
        )
