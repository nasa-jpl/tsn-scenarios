...
try:
    ...
    ti = ixNetwork.Traffic.TrafficItem.add(
        Name="Ethernet 10 Kbps 128 byte frame",
        BiDirectional=False,
    ...
    configElement.FrameRate.update(
        Type="bitsPerSecond", BitRateUnitsType="kbitsPerSec", Rate=10
    )
    ...
    ########################################################################################################
    ti = ixNetwork.Traffic.TrafficItem.add(
        Name="UDP 10% line rate 256 byte frame", BiDirectional=False, TrafficType="ipv4"
    )
    ...
    ########################################################################################################
    ti = ixNetwork.Traffic.TrafficItem.add(
        Name="Ethernet 1000 fps", BiDirectional=False, TrafficType="ethernetVlan"
    )
    ...
    ########################################################################################################
    ti = ixNetwork.Traffic.TrafficItem.add(
        Name="Ethernet 1000 fps 250us offset priority 3",
        BiDirectional=False,
        TrafficType="ethernetVlan",
    )
    ...
    configElement.TransmissionControl.update(
        StartDelay=250, StartDelayUnits="microseconds"
    )
    ...
    ########################################################################################################
    ti = ixNetwork.Traffic.TrafficItem.add(
        Name="Ethernet 1000000 byte burst every 10 sec",
        BiDirectional=False,
        TrafficType="ethernetVlan",
    )
    ti.EndpointSet.add(Sources=ep1_eth1, Destinations=ep3_eth1)
